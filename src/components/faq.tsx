...
import styles from "@/app/assets/styles/FAQ.module.css"
    ...
    const faqList = [
        {
            ...
            answer:
                "Pour créer une tâche, cliquez sur le bouton 'Créer une tâche' et remplissez les informations nécessaires.",
        },
        {
        ...
        },
        {
            ...
            answer:
                "Pour éditer une tâche, cliquez sur l'icône de crayon à côté de la tâche que vous souhaitez modifier.",
        },
    ];
